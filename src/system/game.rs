...
impl Plugin for GamePlugin {
    fn build(&self, app: &mut App) {
        app
            .add_state::<system::game_state::GameState>()
            ...
            .add_systems(OnEnter(system::game_state::GameState::Init), (
            ...
            .add_systems(OnEnter(system::game_state::GameState::Ready), (
            ...
            .run_if(in_state(system::game_state::GameState::Ready)))
            .add_systems(OnEnter(system::game_state::GameState::Playing), core::update::time::start)
            .add_systems(Update, (
            ...
            ).run_if(in_state(system::game_state::GameState::Playing)))
            .add_systems(OnEnter(system::game_state::GameState::Defeated), (
            ...
            .add_systems(OnEnter(system::game_state::GameState::Win), (
