...
impl TextureType {
    pub fn get_path(&self) -> &str {
        match self {
            TextureType::Cells => "images/cells.png",
            TextureType::Smiles => "images/smiles.png",
            TextureType::Numbers => "images/numbers.png",
            TextureType::CornerLeftBottom => "images/corner_left_bottom.png",
            TextureType::CornerLeftTop => "images/corner_left_top.png",
            TextureType::CornerRightBottom => "images/corner_right_bottom.png",
            TextureType::CornerRightTop => "images/corner_right_top.png",
            TextureType::CornerLeftUpperTop => "images/corner_left_upper_top.png",
            TextureType::CornerRightUpperTop => "images/corner_right_upper_top.png",
            TextureType::EdgeLeft => "images/edge_left.png",
            TextureType::EdgeRight => "images/edge_right.png",
            TextureType::EdgeTop => "images/edge_top.png",
            TextureType::EdgeBottom => "images/edge_bottom.png",
            TextureType::EdgeLeftUpper => "images/edge_left_upper.png",
            TextureType::EdgeRightUpper => "images/edge_right_upper.png",
            TextureType::EdgeTopUpper => "images/edge_top_upper.png",
            TextureType::Background => "images/background.png",
            TextureType::Number => "images/number.png",
            TextureType::Smile => "images/smile.png",
        }
    }
